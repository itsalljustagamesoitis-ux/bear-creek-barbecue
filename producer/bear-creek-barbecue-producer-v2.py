#!/usr/bin/env python3
"""
bear-creek-barbecue producer — thin shell over affiliate-platform producer.

All logic lives in affiliate-platform/producer/producer_main.py.

Usage:
  python3 producer/bear-creek-barbecue-producer-v2.py --id 3
  python3 producer/bear-creek-barbecue-producer-v2.py --count 10
  python3 producer/bear-creek-barbecue-producer-v2.py --count 5 --type Roundup
  python3 producer/bear-creek-barbecue-producer-v2.py --slug my-article-slug
  python3 producer/bear-creek-barbecue-producer-v2.py --dry-run --count 5
"""
